...
SCRIPTS = {
    "run_i_s_claims": "Dags/02.silver_layer/scripts/04.load_I_S_PAYMENTS.sql",
    "run_i_claims_to_claims": "Dags/02.silver_layer/scripts/04.load_I_S_PAYMENTS_to_load_S_PAYMENTS.sql",
}
...
@dag(
    dag_id="silver_PAYMENTS_load",
    default_args=default_args,
    schedule=None,
    start_date=pendulum.datetime(2026, 1, 1, tz="UTC"),
    catchup=False,
    max_active_runs=1,
    tags=["redshift", "silver", "payments"],
)
def silver_PAYMENTS_load():
    @task
    ...
    redshift_tasks = [
        RedshiftDataOperator(
            ...
            outlets=[SILVER_PAYMENTS_ASSET] if i == last_index else None,
        )
