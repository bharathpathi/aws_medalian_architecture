...
SCRIPTS = {
    "run_i_s_members": "Dags/02.silver_layer/scripts/01.load_I_S_MEMBERS.sql",
    "run_i_members_to_members": "Dags/02.silver_layer/scripts/01.load_I_S_MEMBERS_to_load_S_MEMBERS.sql",
}
...
@dag(
    dag_id="silver_members_load",
    default_args=default_args,
    schedule=None,
    start_date=pendulum.datetime(2026, 1, 1, tz="UTC"),
    catchup=False,
    max_active_runs=1,
    tags=["redshift", "silver", "members"],
)
def silver_members_load():
    @task
    ...
    redshift_tasks = [
        RedshiftDataOperator(
            ...
            outlets=[SILVER_MEMBERS_ASSET] if i == last_index else None,
        )
