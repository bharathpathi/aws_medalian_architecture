...
SQL_KEY = "Dags/01.bronze_layer/scripts/b_members.sql"
ATHENA_DATABASE = "opt_enrollment_t"
ATHENA_WORKGROUP = "primary"
ATHENA_OUTPUT_LOCATION = "s3://backupaws-queries/"

LANDING_PREFIX = "landing/enrollment/members/"
...
@dag(
    dag_id="b_members_athena_load",
    default_args=default_args,
    schedule=None,
    start_date=pendulum.datetime(2026, 1, 1, tz="UTC"),
    catchup=False,
    max_active_runs=1,
    tags=["athena", "enrollment", "b_members"],
)
def b_members_athena_load():
    ...
    trigger_silver_load = TriggerDagRunOperator(
        task_id="trigger_silver_members_load",
        trigger_dag_id="silver_members_load",
    )
    sql >> athena_tasks[0]
